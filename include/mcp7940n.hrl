...
%% HOUR REGISTER
%% ====================================================================
-define(RTC_HOUR_BIT_TIME_FORMAT_12H,		?RTC_12H_Mode).
-define(RTC_HOUR_BIT_TIME_FORMAT_24H,		?RTC_24H_Mode).
-define(RTC_HOUR_BIT_TIME_FORMAT_MASK,		2#01000000).

%% If 12H format
-define(RTC_HOUR_BIT_12H_AMPM_IND_PM,	?RTC_PM_Mode).
-define(RTC_HOUR_BIT_12H_AMPM_IND_AM,	?RTC_AM_Mode).
...
-define(RTC_WKDAY_BIT_VBATEN_EN,			?RTC_VBAT_EN).
-define(RTC_WKDAY_BIT_VBATEN_DIS,			?RTC_VBAT_DIS).
-define(RTC_WKDAY_BIT_VBATEN_MASK,			2#00001000).
...
-type time_24h()		::	{hour(), minute(), second()}.
-type time()			::	time_12h() | time_24h().
-type date()			::	{year(), month(), day()}.
-type datetime_12h()	::	{date(), time_12h()}.
-type datetime_24h()	::	{date(), time_24h()}.
-type datetime()		::	datetime_12h() | datetime_24h().
