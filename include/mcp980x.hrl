...
-define(CONFIGURATION_REG_ADC_RESOLUTION_TEMP_VALUE_LIST, 
		[
		 {?CONFIGURATION_REG_ADC_RESOLUTION_9BIT_05C, 0.5},
		 {?CONFIGURATION_REG_ADC_RESOLUTION_10BIT_025C, 0.25},
		 {?CONFIGURATION_REG_ADC_RESOLUTION_11BIT_0125C, 0.125},
		 {?CONFIGURATION_REG_ADC_RESOLUTION_12BIT_00625C, 0.0625}
		 ]).
